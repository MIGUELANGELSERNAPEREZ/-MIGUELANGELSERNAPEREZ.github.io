     ...
     <footer class="page-footer font-small blue-grey lighten-5">
        ...
        <div class="row mt-3 dark-grey-text">
            ...
            <!-- Content -->
            <h6 class="text-uppercase font-weight-bold">ITSUR</h6>
            <hr class="teal accent-3 mb-4 mt-0 d-inline-block mx-auto" style="width: 60px;">
            <p>Pagina realizada por alumnos de la carrera de ingenieria en Sistemas Computacionales del
                ITSUR.</p>
        ...
        <a class="dark-grey-text" href="http://www.itsur.edu.mx/"> ITSUR.com</a>
        </div>
        <!-- Copyright -->
